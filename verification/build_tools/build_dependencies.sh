...
if [ ! -d "llvm-project" ]; then
  ...
  git apply ../../build_tools/patches/llvm/enable-emit-c-for-more-ops.patch
  git apply ../../build_tools/patches/llvm/translate-to-cpp.patch
  popd
fi
...
# Pull
if [ ! -d "cbmc" ]; then
  git clone https://github.com/polgreen/cbmc.git
  pushd cbmc
  git checkout rational_fixes
